---
document_id: PLT-EVA-CAP-001
level: 3
level_name: platform
domain: conversational_banking
product: null
platform: eva_dbu
platform_full_name: Enterprise Virtual Assistant (EVA DBU)
...
# EVA DBU Platform Capabilities

Machine-readable capability slice for EVA DBU. Narrative platform knowledge lives
in `3.1 - EVA DBU.md` (`PLT-EVA-001`). This companion is what the Platform
